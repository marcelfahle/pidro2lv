defmodule Pidro2lv.Accounts.Player do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Pidro2lv.Repo)
  ...
  defp validate_username(changeset) do
    ...
    |> validate_format(:username, ~r/^[a-zA-Z0-9_-]+$/, message: "only letters, numbers, underscores and dashes are allowed")
    |> validate_length(:username, min: 2, max: 20)
    |> unsafe_validate_unique(:username, Pidro2lv.Repo)
  ...
  """
  def valid_password?(%Pidro2lv.Accounts.Player{hashed_password: hashed_password}, password)
