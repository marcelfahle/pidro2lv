defmodule Pidro2lv.Accounts do
  @moduledoc """
  ...
  alias Pidro2lv.Accounts.{Player, PlayerToken, PlayerNotifier}
  ...
  ## Examples
      ...
      iex> get_player_by_username_and_password("mf", "correct_password")
      %Player{}

      iex> get_player_by_username_and_password("mf", "invalid_password")
      nil
