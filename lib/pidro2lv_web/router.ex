defmodule Pidro2lvWeb.Router do
  use Pidro2lvWeb, :router

  import Pidro2lvWeb.PlayerAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {Pidro2lvWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: Pidro2lvWeb.Telemetry
    end
  end
